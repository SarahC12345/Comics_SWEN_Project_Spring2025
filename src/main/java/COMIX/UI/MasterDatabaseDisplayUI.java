...
public class MasterDatabaseDisplayUI implements UISection{
    public UISection section;
        public boolean signedIn;
        public List<Comic> comics;
        public int startID;
        public MasterDatabaseDisplayUI(boolean signedIn, List<Comic> comics){
        ...
        public void takeInput(char x){
            ...
            switch (x) {
                ...
                case '9':
                    ...
                    section = new ComicDisplayUI(signedIn, comics.get(Character.getNumericValue(x)+startID),null,true);
                    break;
                case 'p':
                case 'P':
                    if(startID != 0){
